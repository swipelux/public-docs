...
description: "Authentifizieren Sie Swipelux-API-Anfragen mit dem X-API-Key-Header vom geschützten Backend, trennen Sie Sandbox- und Live-Schlüssel sicher vom Client."
---
