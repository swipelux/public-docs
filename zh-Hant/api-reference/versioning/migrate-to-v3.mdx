---
title: "遷移至 v3"
description: "分兩階段將既有的 v1 或 v2 整合遷移至 Swipelux API v3 的完整指南:先理解新的物件模型與客戶、能力、轉帳等核心概念,再逐一對照新舊端點映射、狀態機與欄位差異,最後依照遷移檢查清單驗證客戶入駐、轉帳與 webhooks 事件行為,確保整合平順升級不中斷。"
sidebarTitle: "遷移至 v3"
---
...
| `POST /v2/.../documents/upload-token` 加 `POST /v2/documents/direct-upload` | 已移除,直接以您的 API key 上傳(見下) |
