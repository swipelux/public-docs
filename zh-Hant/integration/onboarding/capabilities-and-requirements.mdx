---
title: "能力與任務"
description: "探索、申請並啟用客戶在每種支付流程所需的能力(capabilities),透過 API 查詢並完成待辦的 KYC 或 KYB 任務、提交所需文件,並了解共用(pooled)與具名(named)帳戶類型的差異與適用情境,以符合 Swipelux 的合規要求並讓客戶順利開通入金與出金功能。"
---
