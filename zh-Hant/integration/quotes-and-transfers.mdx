---
title: "報價與轉帳"
description: "透過 Swipelux API 為精確金額請求報價(quote),了解報價的有效期限與匯率鎖定機制,使用冪等鍵(idempotency key)安全地執行一次報價以建立轉帳,並沿著轉帳狀態機追蹤每筆交易從建立、處理到最終結算的完整生命週期,搭配 webhooks 事件即時掌握進度。"
---
