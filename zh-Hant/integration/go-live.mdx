---
title: "上線"
description: "啟用 Swipelux 正式環境空間並完成上線前準備:將正式與 sandbox 沙箱的設定和 API 金鑰徹底分離、定期輪替金鑰、設定正式環境的 webhooks 端點,並以受控的小額真實資金測試逐一驗證每項能力,確保入金、出金與發行銀行帳戶流程在生產環境中穩定運作。"
---
...
回到[常見流程](/zh-Hant/integration/common-flows) 查看產品路徑,或使用 [API 參考](/zh-Hant/api-reference/introduction) 檢視精確的契約。
