...
Když úkol vrátí `verificationSessions` nebo `tosSessions`, uložte `id` každé relace a aktuální `url`. Odešlete zákazníka na vrácenou URL a poté znovu přečtěte úkol. Jde o akce v rozsahu úkolu, nikoli o samostatný životní cyklus ověření zákazníka.
