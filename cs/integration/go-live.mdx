...
description: "Aktivujte produkční prostor Swipelux, oddělte živou konfiguraci od sandboxu, rotujte API klíče a spusťte každou capability řízeným testem."
---
...
Vraťte se k [Běžné toky](/cs/integration/common-flows) pro produktovou cestu nebo použijte [API Reference](/cs/api-reference/introduction) pro přesné kontrakty.
