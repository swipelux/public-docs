...
API-referenssi on Swipelux API:n arvovaltainen sopimus. Kukin toiminto näyttää pyyntönsä, vastauksensa, tietoturvan, tilan ja virheskeemat. Käytä [Virheet ja uudelleenyritykset](/fi/integration/errors) -sivua täydelliseen julkiseen ongelmaluetteloon ja ratkaisuohjeisiin.
...
Käytä toiminnon dokumentoituja ongelmaskeemoja päättääksesi, korjataanko syöte, päivitetäänkö resurssin tila, suoritetaanko tehtävä vai uudelleenyritetäänkö. Katso [Virheet ja uudelleenyritykset](/fi/integration/errors) jokaista julkista `code`-arvoa, vakaata ongelmatyypin URI:a, uudelleenyrityskäyttäytymistä ja seuraavaa toimenpidettä varten.
