...
You do not need a complete owner roster before requesting a capability. When no qualifying beneficial owner exists yet, the capability is still created as `restricted` with open tasks that request the ownership structure and a qualifying owner. See the [beneficial-owner prerequisite](/integration/onboarding/capabilities-and-requirements#beneficial-owner-prerequisite-for-businesses).
