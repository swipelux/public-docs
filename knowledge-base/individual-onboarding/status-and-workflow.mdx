...
description: "Separate Swipelux KYC review concepts from the current capability, application, task, and submission states so you can map policy status to API values."
---
