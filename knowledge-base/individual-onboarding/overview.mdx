...
Follow the [individual onboarding guide](/integration/onboarding/customers#individual-customers), [Tasks and submissions](/integration/onboarding/capabilities-and-requirements#complete-requirements), and the [individual API workflow map](/knowledge-base/individual-onboarding/api-workflow).
