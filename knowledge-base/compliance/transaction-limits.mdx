...
description: "Transaction limits for individual and business customers based on verification level."
---
...
For implementation guidance, see [individual onboarding](/integration/onboarding/individuals) and [business onboarding](/integration/onboarding/businesses).
