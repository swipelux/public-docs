---
title: "Éles indulás"
description: "Aktiváljon éles környezetet, különítse el az éles konfigurációt és induljon el egy kontrollált teszttel."
---
...
- [ ] Kezelje a dokumentált [API-hibákat és újrapróbálkozásokat](/hu/integration/errors), beleértve az idempotens újrapróbálásokat az eredeti kulccsal.
...
Térjen vissza a [Gyakori folyamatok](/hu/integration/common-flows) oldalra a termékútvonalért, tekintse át a [Hibák és újrapróbálkozások](/hu/integration/errors) oldalt a hibakezeléshez, vagy használja az [API referenciát](/hu/api-reference/introduction) a pontos szerződésekhez.
