...
description: "Kétlépéses migrációs útmutató a Swipelux API v1 és v2 verzióról v3-ra: előbb az objektummodell fogalmai, majd végpont-megfeleltetések és ellenőrzőlista."
