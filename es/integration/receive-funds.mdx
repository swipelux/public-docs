...
description: "Crea un cobro fiat de un solo uso en Swipelux, muestra las instrucciones de pago por banco o tarjeta y liquida los fondos en la cartera del cliente."
---
