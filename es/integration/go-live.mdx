...
- [ ] Gestiona los [errores y reintentos de la API](/es/integration/errors) documentados, incluidos los reintentos idempotentes con la clave original.
...
Vuelve a [Flujos comunes](/es/integration/common-flows) para el recorrido de producto, revisa [Errores y reintentos](/es/integration/errors) para la gestión de fallos, o utiliza la [Referencia de la API](/es/api-reference/introduction) para los contratos exactos.
