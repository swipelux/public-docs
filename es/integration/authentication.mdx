...
Si una solicitud devuelve `unauthorized` o `forbidden`, utiliza [Errores y reintentos](/es/integration/errors) para distinguir entre credenciales inválidas y permisos faltantes.
