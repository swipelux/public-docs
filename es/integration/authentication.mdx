---
title: "Autenticación"
description: "Autentica las solicitudes a la API de Swipelux con la cabecera X-API-Key desde un backend protegido y separa las claves de sandbox y de producción."
---
