...
description: "Sigue la secuencia de onboarding de empresas en Swipelux: etapas de revisión KYB, diligencia reforzada, plazos y política de rechazo y nueva solicitud."
---
...
No necesitas un listado completo de propietarios antes de solicitar una capacidad. Cuando aún no existe ningún beneficiario final que califique, la capacidad se crea de todos modos como `restricted` con tareas abiertas que solicitan la estructura de propiedad y un propietario que califique. Consulta el [prerrequisito de beneficiario final](/es/integration/onboarding/capabilities-and-requirements#beneficial-owner-prerequisite-for-businesses).
