...
`relationship` は、受取人があなたの顧客とどのような関係にあるかを示します。`employee`、`contractor`、`vendor`、`subsidiary`、`merchant`、`customer`、`landlord`、`family`、`other` のいずれかを送信してください。このフィールドはこれらの値のみを受け付けます。`other` に付随する自由記述の説明はありません。
