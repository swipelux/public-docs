---
title: "顧客"
description: "ケイパビリティ、ウォレット、銀行口座、送金を所有する個人または法人の Swipelux 顧客を API で作成し、適切なオンボーディングプロファイルを紐づける方法を解説します。externalId を使った自社システムとの安定したマッピングの設計指針も扱います。"
---
...
顧客データをエクスポートする必要がある場合は、[`POST /v3/customers/{customerId}/export`](/api-reference/customers/post-v3-customers-by-customer-id-export) を使用し、リクエストスキーマに従ってください。
