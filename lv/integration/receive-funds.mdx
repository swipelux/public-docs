...
description: "Izveidojiet vienreizēju Swipelux fiat iemaksu, parādiet precīzas bankas vai kartes instrukcijas un ieskaitiet saņemtos līdzekļus klienta makā."
---
...
Bankas instrukcijās metodēm `ach`, `wire`, `rtp` un `swift` var būt iekļauti arī neobligātie lauki `bankName`, `bankAddress`, `accountHolderName` un `accountHolderAddress`. Parādiet katru atgriezto lauku blakus pārējām bankas koordinātām. Sūtītājbankas bieži pieprasa saņēmējbankas adresi `swift` un citiem starptautiskiem pārskaitījumiem, tāpēc parādiet `bankAddress` vienmēr, kad tas tiek atgriezts.
