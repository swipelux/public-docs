...
## Pabeidziet pašreizējos uzdevumus
...
Ja uzdevums atgriež `verificationSessions` vai `tosSessions`, saglabājiet katras sesijas `id` un pašreizējo `url`. Nosūtiet klientu uz atgriezto URL, pēc tam atkārtoti nolasiet uzdevumu. Tās ir uzdevuma mērogā ierobežotas darbības, nevis atsevišķs klienta verifikācijas dzīves cikls.

### Augšupielādējiet dokumentus
