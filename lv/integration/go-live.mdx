...
description: "Aktivizējiet produkcijas telpu, atdaliet dzīvo konfigurāciju un uzsāciet ar kontrolētu testu."
---
...
- [ ] Apstrādājiet dokumentētās [API kļūdas un atkārtotos mēģinājumus](/lv/integration/errors), tostarp idempotentus atkārtojumus ar sākotnējo atslēgu.
...
Atgriezieties pie [Biežākās plūsmas](/lv/integration/common-flows), lai iepazītos ar produkta ceļojumu, pārskatiet [Kļūdas un atkārtoti mēģinājumi](/lv/integration/errors) kļūmju apstrādei vai izmantojiet [API atsauci](/lv/api-reference/introduction) precīziem līgumiem.
