---
title: "Receive funds"
description: "Create a one-time fiat pay-in and present the exact funding instructions for that transfer."
---
...
Create the price with [`POST /v3/quotes`](/api-reference/money-movement/post-v3-quotes). Send a unique `Idempotency-Key` for this intended quote.
...
Execute the current quote before expiry with [`POST /v3/transfers`](/api-reference/money-movement/post-v3-transfers). Use a new `Idempotency-Key` for this intended transfer.
