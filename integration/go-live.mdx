---
title: "Go live"
description: "Activate a production space, separate live configuration, and launch with a controlled test."
---
...
Return to [Common flows](/integration/common-flows) for the product journey, or use the [API v3 reference](/api-reference/introduction) for exact contracts.
