...
description: "Provision reusable IBAN or virtual account bank details for a Swipelux customer wallet and settle matched fiat deposits automatically into stablecoin balances."
---
...
Use [`POST /v3/customers/{customerId}/accounts`](/api-reference/accounts/post-v3-customers-by-customer-id-accounts) with these headers:
