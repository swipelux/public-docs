...
description: "Request a Swipelux quote for an exact amount, execute one quote safely with idempotency, and track the transfer state machine through settlement."
---
