---
title: "Quickstart"
description: "Create a sandbox Swipelux customer, activate a capability, and run a pay-in, payout, or issued bank account flow end-to-end in a few backend requests."
---
