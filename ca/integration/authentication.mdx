...
Si una sol·licitud retorna `unauthorized` o `forbidden`, utilitza [Errors i reintents](/ca/integration/errors) per distingir les credencials no vàlides dels permisos que falten.
