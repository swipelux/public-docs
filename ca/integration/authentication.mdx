---
title: "Autenticació"
description: "Autentica les sol·licituds a l'API de Swipelux amb la capçalera X-API-Key des d'un backend protegit, separa claus de sandbox i producció i no les exposis."
---
