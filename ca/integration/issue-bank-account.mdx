...
description: "Provisiona dades bancàries reutilitzables (IBAN o compte virtual) per a la cartera d'un client de Swipelux i liquida els dipòsits fiat en stablecoins."
---
