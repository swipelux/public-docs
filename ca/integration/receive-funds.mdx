---
title: "Rebre fons"
description: "Crea un cobrament fiat d'un sol ús a Swipelux, mostra les instruccions de finançament per banc o targeta i liquida els fons a la cartera del client."
---
