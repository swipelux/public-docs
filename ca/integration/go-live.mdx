...
description: "Activa un espai de producció de Swipelux, separa la configuració en viu de la de sandbox, rota les claus i llança cada capacitat amb una prova controlada."
---
...
Torna a [Fluxos comuns](/ca/integration/common-flows) per al recorregut del producte, o utilitza la [referència de l'API](/ca/api-reference/introduction) per als contractes exactes.
