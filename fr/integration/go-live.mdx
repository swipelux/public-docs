...
- [ ] Gérez les [erreurs et nouvelles tentatives API](/fr/integration/errors) documentées, y compris les tentatives idempotentes avec la clé d'origine.
...
Retournez à [Flux courants](/fr/integration/common-flows) pour le parcours produit, consultez [Erreurs et nouvelles tentatives](/fr/integration/errors) pour la gestion des échecs, ou utilisez la [Référence API](/fr/api-reference/introduction) pour les contrats exacts.
