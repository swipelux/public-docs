...
description: "Découvrez, demandez et activez une capacité client pour un flux de paiement, complétez les tâches ouvertes et choisissez entre les types de compte mutualisés et nominatifs."
---
