...
description: "Swipelux KYC review अवधारणाओं को वर्तमान capability, application, task और submission states से अलग करें, ताकि नीति status को API values से map कर सकें।"
---
