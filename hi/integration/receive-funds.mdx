...
### Card, Apple Pay या Google Pay के लिए checkout preference request करें

Card quote के लिए, आप उसी request में एक वैकल्पिक `paymentMethod` शामिल कर सकते हैं, जिसका मान `card`, `apple_pay` या `google_pay` हो। जब वह method customer और उसके device के लिए उपलब्ध होती है, तो hosted checkout उसी method पर खुलता है, और customer फिर भी checkout द्वारा दी गई कोई भी अन्य method चुन सकता है। default preference बनाए रखने के लिए इसे छोड़ दें।
...
`paymentMethod` एक preference है, guarantee नहीं। Apple Pay और Google Pay की उपलब्धता customer, उसके device और checkout पर निर्भर करती है, इसलिए किसी method को request करने से वह उपलब्ध नहीं हो जाती। यह preference quote की capability, amounts या fees को नहीं बदलती, और checkout अंतिम fees की पुष्टि करता है। Transfer reads request किया गया मान लौटाते हैं; वे यह पुष्टि नहीं करते कि customer ने कौन सी method इस्तेमाल की। ऐसे quote के लिए `paymentMethod` भेजना जो card quote नहीं है, ignore होने के बजाय validation में fail हो जाता है, और उसी idempotency key के साथ replay में वही `paymentMethod` भेजना होगा।
