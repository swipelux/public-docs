...
description: "एक बार का Swipelux fiat pay-in बनाएँ, बैंक या कार्ड की सटीक funding instructions प्रस्तुत करें और प्राप्त funds को ग्राहक की wallet में settle करें।"
---
...
Bank instructions में `ach`, `wire`, `rtp` और `swift` methods पर वैकल्पिक `bankName`, `bankAddress`, `accountHolderName` और `accountHolderAddress` फ़ील्ड भी शामिल हो सकते हैं। लौटाए गए प्रत्येक फ़ील्ड को अन्य bank coordinates के साथ प्रदर्शित करें। भेजने वाले बैंक अक्सर `swift` और अन्य international wires के लिए receiving bank का पता माँगते हैं, इसलिए जब भी `bankAddress` लौटाया जाए, उसे प्रदर्शित करें।
