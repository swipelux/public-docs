---
title: "Go live"
description: "Swipelux production space सक्रिय करें, live configuration को sandbox से अलग रखें, API keys rotate करें और real-money test के साथ capability launch करें।"
---
...
Product journey के लिए [Common flows](/hi/integration/common-flows) पर लौटें, या सटीक contracts के लिए [API Reference](/hi/api-reference/introduction) का उपयोग करें।
