...
`relationship` वर्णन करता है कि recipient आपके customer से कैसे संबंधित है। `employee`, `contractor`, `vendor`, `subsidiary`, `merchant`, `customer`, `landlord`, `family`, या `other` में से एक भेजें। यह field केवल इन्हीं मानों को स्वीकार करता है; `other` के साथ कोई free-text description नहीं होती।
