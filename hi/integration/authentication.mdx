...
description: "सुरक्षित backend से X-API-Key के साथ Swipelux API requests को authenticate करें, अलग sandbox और live keys उपयोग करें और keys को client code से बाहर रखें।"
---
