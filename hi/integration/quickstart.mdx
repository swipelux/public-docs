---
title: "Quickstart"
description: "Sandbox में Swipelux customer बनाएँ, capability सक्रिय करें और कुछ ही backend requests में pay-in, payout या issued bank account flow end-to-end चलाएँ।"
---
