---
title: "API reference"
description: "Swipelux v3 API contract का उपयोग करें, X-API-Key से authenticate करें, idempotency keys के साथ writes को सुरक्षित retry करें और error schemas संभालें।"
---
