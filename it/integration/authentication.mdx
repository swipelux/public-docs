...
description: "Autentica le richieste all'API Swipelux con l'header X-API-Key da un backend protetto, usa chiavi sandbox e live separate, tienile fuori dal codice client."
---
