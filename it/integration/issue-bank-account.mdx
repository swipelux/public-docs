...
description: "Fornisci coordinate bancarie riutilizzabili e regola i depositi accoppiati in un wallet cliente."
---
...
Crea un wallet emesso tramite [Conti e wallet](/it/integration/accounts#crea-il-conto), poi rileggilo. Prosegui solo quando il suo stato corrente consente il regolamento.
