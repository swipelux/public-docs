---
title: "Go live"
description: "Attiva uno spazio di produzione Swipelux, separa la configurazione live dalla sandbox, ruota le chiavi API e lancia le capability con test controllati."
---
...
Torna a [Flussi comuni](/it/integration/common-flows) per il percorso di prodotto, o usa la [API Reference](/it/api-reference/introduction) per i contratti esatti.
