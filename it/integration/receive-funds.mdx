...
L'arrivo su `redirectUrl` e' solo navigazione del browser. Non conferma che il pagamento o il transfer sia stato completato. Determina il completamento dallo stato del transfer nel passo 4 e dagli eventi webhook.
