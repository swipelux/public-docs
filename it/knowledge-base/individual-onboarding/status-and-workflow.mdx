...
description: "Separa i concetti di revisione KYC Swipelux dagli stati correnti di capability, application, task e submission per mappare lo status ai valori API."
---
...
Consulta [Capability e task](/it/integration/onboarding/capabilities-and-requirements#complete-current-tasks) per il loop di azione corrente.
