---
title: "Workflow KYB"
description: "Segui la sequenza di onboarding business Swipelux: fasi di revisione KYB, trigger di due diligence rafforzata, tempistiche e policy di rifiuto e ridomanda."
---
...
Non ti serve un elenco completo dei proprietari prima di richiedere una capability. Quando non esiste ancora un beneficial owner qualificante, la capability viene comunque creata come `restricted` con task aperti che richiedono la struttura di ownership e un proprietario qualificante. Consulta il [prerequisito del beneficial owner](/it/integration/onboarding/capabilities-and-requirements#beneficial-owner-prerequisite-for-businesses).
