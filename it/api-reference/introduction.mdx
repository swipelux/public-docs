---
title: "API reference"
description: "Usa il contratto dell'API Swipelux v3, autentica con X-API-Key, ritenta le scritture in sicurezza con chiavi di idempotenza e gestisci stati ed errori."
---
