---
title: "迁移到 v3"
description: "分两步将现有的 v1 或 v2 集成迁移到 Swipelux v3 API：先理解新的对象模型与核心概念，再按端点映射表逐一替换旧接口。本指南还提供转账与入驻流程的状态机对照以及完整迁移清单，帮助您完成平滑、可验证的版本升级，迁移期间旧接口仍可正常使用。遇到问题可联系技术支持。"
sidebarTitle: "迁移到 v3"
---
