---
title: "能力与任务"
description: "了解如何通过 Swipelux API 为每种支付流程发现、申请并启用客户能力，完成待办的 KYC 或 KYB 任务，并在共享账户与专属实名账户类型之间做出选择。本页详解能力状态机、任务提交方式以及入驻与合规要求的对应关系，能力是客户开展交易的前提条件。请在创建客户后尽早申请。"
---
