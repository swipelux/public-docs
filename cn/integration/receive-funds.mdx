---
title: "接收资金"
description: "使用 Swipelux API 创建一次性的法币入金转账，向客户展示准确的银行或银行卡付款指令，并在收到资金后自动结算到客户钱包。本页详解入金流程的每个 API 步骤、转账状态变化以及用于对账和通知的 Webhook 事件，适用于单次充值或一次性收款等场景。支持多种法币与支付渠道。"
---
