---
title: "v1 または v2 のインテグレーションを Swipelux API v3 へ移行する"
description: "Swipelux API v1 および v2 から v3 への 2 パス移行ガイド。最初はオブジェクトモデルのコンセプト、次にエンドポイントのマッピング、状態機械、チェックリスト。"
