---
title: "Authenticatie"
description: "Authenticeer Swipelux API-requests met de X-API-Key-header vanaf een beveiligde backend, gebruik aparte sandbox- en live-keys en houd keys uit clientcode."
---
