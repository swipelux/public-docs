---
title: "Go-live"
description: "Activeer een productieomgeving, scheid live configuratie en lanceer met een gecontroleerde test."
---
...
- [ ] Behandel gedocumenteerde [API-fouten en retries](/nl/integration/errors), inclusief idempotente retries met de oorspronkelijke key.
...
Ga terug naar [Common flows](/nl/integration/common-flows) voor de productjourney, bekijk [Fouten en nieuwe pogingen](/nl/integration/errors) voor foutafhandeling of gebruik de [API Reference](/nl/api-reference/introduction) voor exacte contracten.
